		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#portalclientes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"portalclientes-display": {
								"semanticObject": "portalclientes",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=portalclientes",
									"url": sap.ui.require.toUrl("portalclientes")
								}
							}
						}
					}
